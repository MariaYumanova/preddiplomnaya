...
<head>
    ...
    <title>Курс языка программирования Python — Student IT Community</title>
...
<body>
  ...
  <main class="container">
		<nav class="breadcrumb">
                ...
                Курс языка программирования Python
            </nav>
		<header class="entry-header">
			<h1 class="page-title">Курс языка программирования Python</h1>
		</header>
		<div class="main-content">

			<div class="entry-content">
				<div class="product-header">
                    <h1 class="product-title">Курс языка программирования Python</h1>
                    ...
                    <div class="tab-content">
                        ...
                        <p><strong>Полное погружение в Python</strong> – от основ до продвинутых тем</p>
                        <p><strong>Практические навыки</strong> – реальные проекты для портфолио</p>
                        <p><strong>Доступ к чату поддержки</strong> – помощь преподавателя и комьюнити</p>

                        <h4><strong>Что входит в курс?</strong></h4>
                        <p><strong>50+ видеоуроков</strong> (доступ на 12 месяцев)</p>
                        <p><strong>20 практических заданий</strong></p>
                        <p><strong>Готовые шаблоны проектов</strong></p>
                        <p><strong>Доп. материалы</strong>: шпаргалки, чек-листы, полезные ресурсы</p>
                    </div>
                </div>
