...
<head>
    ...
    <title>Курс языка программирования 1С — Student IT Community</title>
...
<body>
  ...
  <main class="container">
		<nav class="breadcrumb">
                ...
                Курс языка программирования 1С
            </nav>
		<header class="entry-header">
			<h1 class="page-title">Курс языка программирования 1С</h1>
		</header>
		<div class="main-content">

			<div class="entry-content">
				<div class="product-header">
                    <h1 class="product-title">Курс языка программирования 1С</h1>

                    <div class="product-price">

                        <span class="sale-price">6780,00 ₽</span>
                    </div>
                    ...
                    <div class="tab-content">
                        ...
                        <p><strong>Полное погружение в 1С 8.3</strong> – от основ до сложных механизмов</p>
                        <p><strong>Практические навыки</strong> – реальные кейсы из бизнеса</p>
                        <p><strong>Доступ к закрытому чату</strong> – поддержка преподавателя и комьюнити</p>

                        <h4><strong>Что входит в курс?</strong></h4>
                        <p><strong>45 видеоуроков</strong> (доступ на 12 месяцев)</p>
                        <p><strong>15 практических заданий</strong></p>
                        <p><strong>Шаблоны типовых конфигураций</strong></p>
                        <p><strong>Доп. материалы</strong>: чек-листы, шпаргалки, ГОСТы</p>
                    </div>
                </div>
