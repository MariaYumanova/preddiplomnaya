		...
		<div class="main-content">
		 ...
		 <style>
												...
												<div style="text-align: center; margin: 30px 0;">
												    <a href="../../generate_orders.php" class="contact-btn" style="background: #2c3e50;">
												        📊 Сгенерировать отчет по заказам
												    </a>
														<a href="/my-account/file_manager.php" class="contact-btn" style="background: #40B198; margin: 10px;">
												        📁 Файловый менеджер
												    </a>
												</div>
