  ...
  <main class="container">
		...
		<div class="main-content">
			...
			<div class="entry-content">
					...
					<h2 class="poll-title">Данные пользователей</h2>
		...
		<form  action="../add.php" method="post" novalidate>
			...
			<p >
				...
				<input type="text" class=" input-text" name="userpol" id="userpol" autocomplete="userpol" value="" required aria-required="true">
			</p>
